 <footer id="footer" class="footer light-background">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            <span class="sitename">{{ $settings['sitename'] ?? 'BloodBridge'}}</span>
          </a>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">{{ $settings['sitename'] ?? 'BloodBridge'}}</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
